                    ...
                    <div className="md:flex md:items-center md:justify-between">
                        ...
                        <form className="flex space-x-2">
                            <input
                                ...
                                className="px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
                                required
                            />
                            <button
                                type="submit"
                                className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm font-semibold rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all"
                            >
                                Subscribe
                            </button>
                        </form>
                ...
                <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
                    <div className="md:flex md:items-center md:justify-between">
                        ...
                        <div className="mt-4 md:mt-0 flex space-x-6">
                            ...
                            <Link href="/cookies" className="text-sm text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                                Cookie Settings
                            </Link>
                        </div>
                    </div>
